...
from tables.models import Filial, Department, Employee, Profile, Admin, Table, Cell, Column
from .serializers import (
    ...
    TableListSerializer, TableDetailSerializer, CellSerializer, ColumnSerializer
)
